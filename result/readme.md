...
## 추가 사항(25.11.12)
- 데이터 컬럼 기준은 "Created"가 아닌, "작성날짜" 기준
- total member n 94에서 분석 집중 대상을 추려 68로 집계.
...
- **업무_계정_대분류**, **프로젝트명_소분류**
- **총_프로젝트시간**(4~9월 합)
- **총_표준용량**(= Σ(일 참여자수×8), 같은 기간 공통 분모)
- **총_투입률_표준화(%)** = 총_프로젝트시간 ÷ 총_표준용량 × 100
- **전체_고유_투입인원**(기간 내 한 번이라도 참여)
- **기간_1인_평균시간** = 총_프로젝트시간 ÷ 전체_고유_투입인원
- **월별_투입률_%**: `2025-04_%`, `2025-05_%`, …, `2025-09_%` (각 월의 표준화 기준%)
